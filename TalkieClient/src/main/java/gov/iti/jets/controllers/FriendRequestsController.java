...
public class FriendRequestsController implements Initializable, FXMLController {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // friendRequestFlowPane.getChildren().clear();
        // friendRequestFlowPane.getChildren().addAll( ReceivedfriendRequestFlowPane.getChildren());
    ...
    private void loadOldFriendRequests(){
        try {
            ...
            LoadFriendReqResponse sentResponse = sentFRController.getSentFriendRequestByUserID(new LoadFriendReqRequest(CurrentUser.getInstance().getUser().getPhoneNumber()));
            ...
            LoadFriendReqResponse receivedResponse = receivedFRController.getReceivedFriendReqByUserID(new LoadFriendReqRequest(CurrentUser.getInstance().getUser().getPhoneNumber()));
            receivedResponse.getReceivedFriendRequestList().forEach((x)-> addRecievedFriendRequest(x) );
            // receivedFriendRequestList.forEach((x)->addRecievedFriendRequest(x));
